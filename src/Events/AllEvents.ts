import type { TypedOnErrorEventHandler } from "./TypedEventHandlers/TypedOnErrorEventHandler"; import type { TypedAnimationEvent, TypedDragEvent, TypedEvent, TypedFocusEvent, TypedFormDataEvent, TypedMouseEvent, TypedKeyboardEvent, TypedPointerEvent, TypedProgressEvent, TypedSubmitEvent, TypedTouchEvent, TypedTransitionEvent, TypedWheelEvent, TypedUIEvent, TypedSecurityPolicyViolationEvent, TypedClipboardEvent, } from "./TypedEvents"; import type { TypedInputEvent } from "./TypedEvents/TypedInputEvent"; import type { TypedBeforeUnloadEvent } from "./TypedEvents/TypedBeforeUnloadEvent"; import type { TypedMessageEvent } from "./TypedEvents/TypedMessageEvent"; import type { TypedPageTransitionEvent } from "./TypedEvents/TypedPageTransitionEvent"; import type { TypedPopStateEvent } from "./TypedEvents/TypedPopStateEvent"; import type { TypedPromiseRejectionEvent } from "./TypedEvents/TypedPromiseRejectionEvent"; import type { TypedStorageEvent } from "./TypedEvents/TypedStorageEvent"; export interface AllEvents<T extends EventTarget> {    
/**
...
*/
onafterprint?(ev: TypedEvent<T>): unknown; onanimationcancel?(ev: TypedAnimationEvent<T>): unknown; onanimationend?(ev: TypedAnimationEvent<T>): unknown; onanimationiteration?(ev: TypedAnimationEvent<T>): unknown; onanimationstart?(ev: TypedAnimationEvent<T>): unknown; onauxclick?(ev: TypedMouseEvent<T>): unknown; onbeforeinput?(ev: TypedInputEvent<T>): unknown;    
/**
...
*/
onblur?(ev: TypedFocusEvent<T>): unknown; oncancel?(ev: TypedFocusEvent<T>): unknown;    
/**
...
*/
onclick?(ev: TypedMouseEvent<T>): unknown; onclose?(ev: TypedEvent<T>): unknown;    
/**
The right button of the mouse is clicked (before the context menu is displayed).
*/
oncontextmenu?(ev: TypedMouseEvent<T>): unknown; oncopy?(ev: TypedClipboardEvent<T>): unknown; oncuechange?(ev: TypedEvent<T>): unknown; oncut?(ev: TypedClipboardEvent<T>): unknown;    
/**
...
*/
onended?(ev: TypedEvent<T>): unknown; onenterpictureinpicture?(ev: TypedEvent<T>): unknown;    
/**
...
*/
onfocus?(ev: TypedFocusEvent<T>): unknown; onformdata?(ev: TypedFormDataEvent<T>): unknown; onfullscreenchange?(ev: TypedEvent<T>): unknown; onfullscreenerror?(ev: TypedEvent<T>): unknown; ongamepadconnected?(ev: TypedEvent<T>): unknown; ongamepaddisconnected?(ev: TypedEvent<T>): unknown; ongotpointercapture?(ev: TypedPointerEvent<T>): unknown;    
/**
...
*/
onlanguagechange?(ev: TypedEvent<T>): unknown; onleavepictureinpicture?(ev: TypedEvent<T>): unknown;    
/**
...
Progress has begun.
*/
onloadstart?(ev: TypedEvent<T>): unknown; onlostpointercapture?(ev: TypedPointerEvent<T>): unknown;    
/**
...
*/
onmessage?(ev: TypedMessageEvent<T>): unknown; onmessageerror?(ev: TypedMessageEvent<T>): unknown;    
/**
...
*/
ononline?(ev: TypedEvent<T>): unknown; onpagehide?(ev: TypedPageTransitionEvent<T>): unknown; onpageshow?(ev: TypedPageTransitionEvent<T>): unknown; onpaste?(ev: TypedClipboardEvent<T>): unknown;    
/**
...
*/
onredo?(ev: TypedEvent<T>): unknown; onrejectionhandled?(ev: TypedPromiseRejectionEvent<T>): unknown;    
/**
A form is reset.
*/
...
*/
onscroll?(ev: TypedEvent<T>): unknown; onsecuritypolicyviolation?(ev: TypedSecurityPolicyViolationEvent<T>): unknown;    
/**
...
*/
onselect?(ev: TypedEvent<T>): unknown; onselectionchange?(ev: TypedEvent<T>): unknown; onselectstart?(ev: TypedEvent<T>): unknown;    
/**
A contextmenu event was fired on/bubbled to an element that has a contextmenu attribute
*/
onshow?(ev: TypedEvent<T>): unknown; onslotchange?(ev: TypedEvent<T>): unknown;    
/**
...
*/
ontimeupdate?(ev: TypedEvent<T>): unknown; ontoggle?(ev: TypedEvent<T>): unknown; ontouchcancel?(ev: TypedTouchEvent<T>): unknown; ontouchend?(ev: TypedTouchEvent<T>): unknown; ontouchmove?(ev: TypedTouchEvent<T>): unknown; ontouchstart?(ev: TypedTouchEvent<T>): unknown; ontransitioncancel?(ev: TypedTransitionEvent<T>): unknown; ontransitionend?(ev: TypedTransitionEvent<T>): unknown; ontransitionrun?(ev: TypedTransitionEvent<T>): unknown; ontransitionstart?(ev: TypedTransitionEvent<T>): unknown; onunhandledrejection?(ev: TypedPromiseRejectionEvent<T>): unknown;    
/**
...
*/
onwaiting?(ev: TypedEvent<T>): unknown; onwebkitanimationend?(ev: TypedEvent<T>): unknown; onwebkitanimationiteration?(ev: TypedEvent<T>): unknown; onwebkitanimationstart?(ev: TypedEvent<T>): unknown; onwebkittransitionend?(ev: TypedEvent<T>): unknown; onwheel?(ev: TypedWheelEvent<T>): unknown;}