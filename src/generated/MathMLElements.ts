...
import { DataGlobalAttributes } from "../types"
       export interface GlobalAttributes extends Pick<AllAttributes, "dir" | "displaystyle" | "href" | "id" | "mathvariant" | "scriptlevel"> {}
       
       export interface MathMLElementMath extends Pick<AllAttributes, "display">, DataGlobalAttributes, MathMLEvents, GlobalAttributes {
  /**
...
export interface MathMLElementMerror extends DataGlobalAttributes, MathMLEvents, GlobalAttributes {}
export interface MathMLElementMfrac extends Pick<AllAttributes, "linethickness">, DataGlobalAttributes, MathMLEvents, GlobalAttributes {}
export interface MathMLElementMi extends DataGlobalAttributes, MathMLEvents, GlobalAttributes {}
export interface MathMLElementMmultiscripts extends DataGlobalAttributes, MathMLEvents, GlobalAttributes {}
export interface MathMLElementMn extends DataGlobalAttributes, MathMLEvents, GlobalAttributes {}
export interface MathMLElementMo extends Pick<AllAttributes, "fence" | "largeop" | "lspace" | "maxsize" | "minsize" | "movablelimits" | "rspace" | "separator" | "stretchy" | "symmetric">, DataGlobalAttributes, MathMLEvents, GlobalAttributes {}
export interface MathMLElementMover extends Pick<AllAttributes, "accent">, DataGlobalAttributes, MathMLEvents, GlobalAttributes {}
export interface MathMLElementMpadded extends Pick<AllAttributes, "depth" | "height" | "lspace" | "voffset" | "width">, DataGlobalAttributes, MathMLEvents, GlobalAttributes {}
export interface MathMLElementMphantom extends DataGlobalAttributes, MathMLEvents, GlobalAttributes {}
export interface MathMLElementMroot extends DataGlobalAttributes, MathMLEvents, GlobalAttributes {}
export interface MathMLElementMrow extends DataGlobalAttributes, MathMLEvents, GlobalAttributes {}
export interface MathMLElementMs extends Pick<AllAttributes, "lquote" | "rquote">, DataGlobalAttributes, MathMLEvents, GlobalAttributes {}
export interface MathMLElementMspace extends Pick<AllAttributes, "depth" | "height" | "width">, DataGlobalAttributes, MathMLEvents, GlobalAttributes {}
export interface MathMLElementMsqrt extends DataGlobalAttributes, MathMLEvents, GlobalAttributes {}
export interface MathMLElementMstyle extends DataGlobalAttributes, MathMLEvents, GlobalAttributes {}
export interface MathMLElementMsub extends DataGlobalAttributes, MathMLEvents, GlobalAttributes {}
export interface MathMLElementMsubsup extends DataGlobalAttributes, MathMLEvents, GlobalAttributes {}
export interface MathMLElementMtable extends DataGlobalAttributes, MathMLEvents, GlobalAttributes {}
export interface MathMLElementMtd extends Pick<AllAttributes, "columnspan" | "rowspan">, DataGlobalAttributes, MathMLEvents, GlobalAttributes {}
export interface MathMLElementMtext extends DataGlobalAttributes, MathMLEvents, GlobalAttributes {}
export interface MathMLElementMtr extends DataGlobalAttributes, MathMLEvents, GlobalAttributes {}
export interface MathMLElementMunder extends Pick<AllAttributes, "accentunder">, DataGlobalAttributes, MathMLEvents, GlobalAttributes {}
export interface MathMLElementMunderover extends Pick<AllAttributes, "accent" | "accentunder">, DataGlobalAttributes, MathMLEvents, GlobalAttributes {}
export interface MathMLElementSemantics extends Pick<AllAttributes, "encoding">, DataGlobalAttributes, MathMLEvents, GlobalAttributes {}
